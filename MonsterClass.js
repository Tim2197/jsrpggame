class Monster {
    ...
    setDeath() {
        ...
        console.log(`${this.monsterType} is ${dead}`);
    }
...
console.log(lootMonsterTest.isDead)
console.log(lootMonsterTest.health)
lootMonsterTest.hurt(9)
console.log(lootMonsterTest.health)
console.log(lootMonsterTest.isDead)
lootMonsterTest.checkDeath()
lootMonsterTest.hurt(1)
console.log(lootMonsterTest.isDead)